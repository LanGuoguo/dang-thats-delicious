...
function ajaxHeart(e) {
  ...
  _axios2.default.post(this.action).then(function (resp) {
    ...
    (0, _bling.$)('.heart-count').textContent = resp.data.hearts.length;
    if (isHearted) {
...
function loadPlaces(map) {
  ...
  _axios2.default.get('/api/v1/stores/near?lat=' + lat + '&lng=' + lng).then(function (resp) {
...
function makeMap(mapDiv) {
  ...
  autocomplete.addListener('place_changed', function () {
    var _autocomplete$getPlac = autocomplete.getPlace().geometry.location,
        lat = _autocomplete$getPlac.lat,
        lng = _autocomplete$getPlac.lng;
...
var heartsForm = (0, _bling.$$)('form.heart');
heartsForm.on('submit', _heart2.default);
